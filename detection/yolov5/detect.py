...
def parse_opt():
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[2688], help='inference size h,w')
    ...
    parser.add_argument('--name', default='predictions', help='save results to project/name')
