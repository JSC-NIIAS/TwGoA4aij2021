...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/baseline.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp26/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--batch-size', type=int, default=2, help='batch size')
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=2688, help='inference size (pixels)')
